...
In the GitHub repo, click the Code button and select Open with Codespaces → New codespace.
Once your codespace is ready, open the index.html file via the live preview.
☁️ Cloudflare Note
